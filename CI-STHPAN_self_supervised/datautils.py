...
# Stock data lives under this package directory (not cwd), so pretrain works from any folder.
_STOCK_DATA_ROOT = os.path.normpath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "src", "data", "datasets", "stock")
)
